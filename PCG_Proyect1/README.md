...
3. En la jerarquía, seleccionar el GameObject llamado `Gontrolador`.
...
7. Si quieres modificar ideal primero pulsar "GenerateTearrain" de `TerrainGenerator` y luego presionar "Generar Mundo Completo" para ir en orden
